	  ...
	  {	  
	    ...
	    else if(choice == 'l')       	 
	    {
		    	...
		    	for(int i = 0; i < numCourses; i++)
		        {
		    		 ...
		    		 }while( !(letterGrade1.startsWith("a")) ||  !(letterGrade1.startsWith("a-")) ||
		    				 !(letterGrade1.startsWith("b+")) || !(letterGrade1.startsWith("b")) ||
		    				 !(letterGrade1.startsWith("c+")) || !(letterGrade1.startsWith("c")) ||
		    				 !(letterGrade1.startsWith("d")));
